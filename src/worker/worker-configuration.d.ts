/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker/worker-configuration.d.ts` (hash: e922aeedf148646e886f1f1923846ed1)
// Runtime types generated with workerd@1.20260205.0 2025-07-05 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../../build/worker/worker/index-worker");
		durableNamespaces: "DataForSEOMcpAgent";
	}
	interface Env {
		SEO_CACHE_DB: D1Database;
		ENABLED_MODULES: "KEYWORDS_DATA,DATAFORSEO_LABS,SERP,ONPAGE,BACKLINKS";
		DATAFORSEO_FULL_RESPONSE: "false";
		DATAFORSEO_SIMPLE_FILTER: "false";
		MCP_OBJECT: DurableObjectNamespace<import("../../build/worker/worker/index-worker").DataForSEOMcpAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLED_MODULES" | "DATAFORSEO_FULL_RESPONSE" | "DATAFORSEO_SIMPLE_FILTER">> {}
}
